...
/**
 * Created by hehao on 16/12/29.
 */


@SuppressWarnings("ResourceType")
public class SimpleInputFloatView extends ViewGroup
    ...
    public SimpleInputFloatView(Context context) {
        this(context, null);
    }

    public SimpleInputFloatView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v instanceof SimpleInputFloatView) {
